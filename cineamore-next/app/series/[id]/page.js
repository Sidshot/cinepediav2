            ...
            <div className="relative -mt-48 z-10 px-4 md:px-8 max-w-6xl mx-auto">
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="flex-1 space-y-4">
                        {/* Stream Only Badge */}
                        <div className="inline-block bg-gradient-to-r from-orange-600 to-red-600 text-white text-xs font-bold px-3 py-1 rounded-full">
                            📺 SERIES • STREAM ONLY
                        </div>
                        ...
                        <div className="flex flex-wrap gap-3 items-center">
                            {series.year && (
                                <span className="bg-orange-600 text-white px-3 py-1 rounded-md font-bold text-sm">
                        ...
                        {/* No Download Notice */}
                        <div className="bg-orange-600/10 border border-orange-600/30 text-orange-200 px-4 py-3 rounded-lg text-sm">
                        ...
                        <div className="flex flex-wrap gap-3">
                            ...
                            <a
                                href={`https://www.google.com/search?q=${encodeURIComponent(series.title + ' TV series')}`}
                                target="_blank"
                                rel="noopener noreferrer"
                    ...
                    <div className="flex gap-2 overflow-x-auto pb-4 scrollbar-hide">
                        {series.seasons.map(season => (
                            <Link
                                ...
                                href={`/series/${tmdbId}?s=${season.seasonNumber}&e=1`}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {seasonData.episodes.map(ep => (
                                <Link
                                    ...
                                    href={`/series/${tmdbId}?s=${selectedSeason}&e=${ep.episodeNumber}`}
                                ...
                                >
                                    <div className="flex gap-3">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <p className="text-xs text-orange-400 font-medium">Episode {ep.episodeNumber}</p>
